...
Route::middleware(['auth.admin'])->prefix('admin')->group(function () {
    ...
    Route::get('permission', [PermissionController::class, 'index'])->name('permission.getList');
    Route::get('permission/getCreate/{id?}', [PermissionController::class, 'getCreate'])->name('permission.getCreate');
    Route::post('permission/getCreate/{id?}', [PermissionController::class, 'postCreate'])->name('permission.postCreate');
    Route::post('permission/editPermission', [PermissionController::class, 'editPermission'])->name('permission.editPermission');
    Route::post('permission/removePermission', [PermissionController::class, 'removePermission'])->name('permission.removePermission');
    Route::get('permission/removeGroup', [PermissionController::class, 'removeGroup'])->name('permission.removeGroup');
