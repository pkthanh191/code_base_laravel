            ...
            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                <div>
                    <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                            <svg class="icon">
                                <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-arrow-top') }}">
                                </use>
                            </svg>)</span></div>
                    <div>Income</div>
                </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                ...
                <button class="btn btn-primary" type="button">
                    <svg class="icon">
                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/free.svg#cil-cloud-download') }}">
                        </use>
                    </svg>
                </button>
            </div>
                    ...
                    <table class="table border mb-0">
                        ...
                        <tbody>
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-us') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-br') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-in') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-fr') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-es') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="{{ asset('dist/vendors/@coreui/icons/svg/flag.svg#cif-pl') }}">
                                        </use>
                                    </svg>
                                </td>
                                <td>
